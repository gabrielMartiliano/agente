# ==========================================
# Treinamento de LLaMA-3.2-3B com LoRA e otimizações para placas AMD
# ==========================================    
...
# ==========================================
# 0. CONFIGURAÇÃO DE CAMINHOS (PASTA AMD)
# ==========================================
...
def mostrar_memoria():
    if torch.cuda.is_available():
        ...
        print("[ALERTA] Placa de vídeo não detectada pelo PyTorch. O script falhará se tentar usar 4-bits sem GPU.")
...
print("=== INICIANDO AMBIENTE OTIMIZADO PARA GPU (AMD) ===")
print(f"Buscando dataset em: {caminho_dataset}")
mostrar_memoria()

# ==========================================
# 2. CONFIGURAÇÃO DE MEMÓRIA (4-BITS NF4)
# ==========================================
...
# ==========================================
# 3. CARREGAMENTO DO MODELO (COM SDPA PARA AMD)
# ==========================================
...
model = AutoModelForCausalLM.from_pretrained(
    ...
    device_map="auto",
    attn_implementation="sdpa" # CORRIGIDO AQUI PARA PLACAS AMD
)
mostrar_memoria()
